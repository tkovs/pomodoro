...
describe("Pomodoro application", () => {
  ...
  describe("settings feature", () => {
    ...
    test(
      "should disable back to app button if there is some input with value 0",
      () => {
      Jest.useFakeTimers();
    ...
    test(
      "should update focus time and break time after change the values on settings",
      () => {
      Jest.useFakeTimers();
