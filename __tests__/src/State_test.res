...
describe("State.useReducer", () => {
  ...
  describe("initial state", () => test("should start with initial state", () => {
  ...
  describe("Start action", () => test("should active isTicking after dispatch a Play", () => {
      let initialState = {
        currentPhase: Work,
        isTicking: false,
        maxSessions: 4,
      ...
      expect((container->result->current).state) |> toEqual(initialState) |> ignore
      act(() => (container->result->current).dispatch(State.Start))
      expect((container->result->current).state) |> toEqual(newState)
    }))

  describe("Stop action", () => test("should disable isTicking after dispatch a Stop", () => {
      let initialState = {
        currentPhase: Work,
        isTicking: true,
        maxSessions: 4,
  ...
  describe("Tick action", () => {
    test("with seconds higher than 1 and isTicking true, should decrement 1 second", () => {
      let initialState = {
        currentPhase: Work,
        isTicking: true,
        maxSessions: 4,
    ...
    test("with seconds higher than 1 and isTicking false, should return the same state", () => {
      let initialState = {
        currentPhase: Work,
        isTicking: false,
        maxSessions: 4,
  ...
  describe("Reset action", () => {
    test("on Work phase, should stop ticking and reset seconds to workTime", () => {
      let initialState = {
        currentPhase: Work,
        isTicking: true,
        maxSessions: 4,
    ...
    test("on Play phase, should stop ticking and reset seconds to playTime", () => {
      let initialState = {
        currentPhase: Play,
        isTicking: true,
        maxSessions: 4,
  ...
  describe("SkipTimer", () => {
    ...
    test("on Play phase and not last session, should should update state according", () => {
      let initialState = {
        currentPhase: Play,
        isTicking: true,
        maxSessions: 4,
    ...
    test("on Play phase and last session, should should update state according", () => {
      let initialState = {
        currentPhase: Play,
        isTicking: true,
        maxSessions: 4,
